...
## Responsive Behavior
- phone 390: section 390×1620px; heading 16px; body 15.0619px; 1 col (5 items, gap normal)
- ipad 768: section 768×1279px; heading 16px; body 15.3994px; 1 col (5 items, gap normal)
- pc 1440: section 1440×1599px; heading 16px; body 15.9995px; 1 col (6 items, gap normal)
