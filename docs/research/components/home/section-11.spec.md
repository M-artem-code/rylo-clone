...
page: /
screenshot: docs/design-references/rylo.com/section-11-pc.png
...
## Computed Styles
- **div.pointer-events-none.absolute** [1440×2350]: bg rgb(0, 0, 0); absolute z10; opacity 0
...
## Responsive Behavior
- phone 390: section 390×1380px; body 15.0619px
- ipad 768: section 768×1898px; body 15.3994px
- pc 1440: section 1440×2350px; body 15.9995px
- change: no layout change across viewports
- ipad matches pc layout
- exact per-property values: probe-section-11.json + responsive.json (ground truth)
