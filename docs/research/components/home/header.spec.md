...
## Responsive Behavior
- phone 390: section 390×68px; body 15.0619px; 1 col (6 items, gap 4px)
- ipad 768: section 768×70px; body 15.3994px; 1 col (6 items, gap 4px)
- pc 1440: section 1440×85px; body 15.9995px; 5 cols (5 items, gap 0px)
